...
class GateNetwork(nn.Module):
    def __init__(self,in_dim, num_adapter,considered_channels = -1, depth = 1):
        super().__init__()
        ...
        for i in range(depth):
            ...
            single_layer =  nn.ModuleList([
                conv3x3(in_dim,middle_dim , kernel_size = 3,stride  = 1),
                nn.GELU(),
                nn.MaxPool2d(2, 2)])
        ...
        self.Linear = nn.Linear(middle_dim, self.num_adapter)
