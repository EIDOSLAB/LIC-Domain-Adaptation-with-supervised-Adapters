...
def parse_args_gate(argv):
    ...
    parser.add_argument("--seed", type=float,default = 42, help="Set random seed for reproducibility")
    parser.add_argument("--root", type=str,default = "/scratch/dataset/domain_adapter", help="base root for dataset") #"/scratch/dataset/domain_adapter/MixedImageSets"


    parser.add_argument("--test_classes", nargs='+', type = str, default = ["kodak","sketch","comic"], help = "classes for training the adapters") # ["openimages","sketch","clipart",,"painting","infograph"] #["natural","sketch","infographics"]
    ...
    parser.add_argument("--pret_checkpoint",default = "/scratch/base_devil/weights")
    parser.add_argument("--savepath",default = "/scratch/DCC/q6/")
    ...
    parser.add_argument( "--std", default=0.01, type=float, help="initialization std",) #0.01 #ssss
    ...
    parser.add_argument('--writing',type = str, default =  "", help='adapter loss')
